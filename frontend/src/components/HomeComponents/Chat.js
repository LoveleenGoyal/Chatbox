...
export default function Chat({message,isMale}) {
  ...
  return (
    <MotionAnimate animation="fadeInUp">
       {isMale&&<div className='bg-[#f7b654] max-[1500px]:text-sm max-[528px]:text-xs rounded-t-[20px] rounded-br-[20px] px-[5%] py-[4%] my-[5%] text-black font-Roboto font-bold'>{message}</div>}
